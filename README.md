...
| [security-vulnerability-review](skills/security-vulnerability-review/SKILL.md) | Produces an EMM-Console Application Security Protection mitigation document for specific findings with code evidence and verdicts | SAST/Code scanning findings need false-positive analysis, mitigation proof, or fix recommendations |
